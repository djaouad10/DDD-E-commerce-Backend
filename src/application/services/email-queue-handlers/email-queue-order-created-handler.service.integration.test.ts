...
import { EmailQueueOrderCreatedHandlerService } from "./email-queue-order-created-handler.service.js";
import {
  clearDatabase,
  createUserInDB,
...
import { EmailQueueOrderCreatedHandlerCommand } from "#/application/commands/email-queue-handlers/email-queue-order-created-handler.command.js";
...
describe("EmailQueueOrderCreatedHandlerService", () => {
  let container: Container;
  let service: EmailQueueOrderCreatedHandlerService;
  ...
  beforeAll(async () => {
    ...
    service = new EmailQueueOrderCreatedHandlerService(
      db,
  ...
  describe("Success Path", () => {
    test("when user and order exist, it should send email and persist idempotency key", async () => {
      ...
      const command = new EmailQueueOrderCreatedHandlerCommand(
