...
describe("EmailQueueUserRegisteredHandlerService", () => {
  let container: Container;
  let service: EmailQueueUserRegisteredHandlerService;
  ...
  beforeAll(async () => {
    ...
    service = new EmailQueueUserRegisteredHandlerService(
      db,
  ...
  describe("Success Path", () => {
    test("when user exists, it should send email and persist idempotency key", async () => {
      // Arrange
      ...
      const command = new EmailQueueUserRegisteredHandlerCommand(
